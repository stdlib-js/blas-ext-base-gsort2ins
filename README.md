...
```javascript
import gsort2ins from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsort2ins@v0.2.0-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsort2ins@v0.2.0-esm/index.mjs';
```
