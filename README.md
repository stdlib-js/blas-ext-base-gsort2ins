...
```javascript
gsort2ins = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsort2ins@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gsort2ins/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/blas-ext-base-gsort2ins/actions/workflows/test.yml?query=branch:v0.2.2
